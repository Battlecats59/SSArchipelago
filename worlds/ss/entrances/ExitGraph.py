AP_EXIT_GRAPH = {
    "Upper Skyloft": {
        "Knight Academy Lower Door": ("Upper Skyloft - Knight Academy", "Lower Door"),
        "Knight Academy Upper Door": ("Upper Skyloft - Knight Academy", "Upper Door"),
        "Knight Academy Chimney": "Upper Skyloft - Zelda's Room",
        "Sparring Hall": "Upper Skyloft - Sparring Hall",
        "Goddess Statue": "Upper Skyloft - Goddess Statue",
        "Stairs to Central Skyloft": "Central Skyloft",
        "Loftwing Platforms": "Sky",
    },
    "Upper Skyloft - Knight Academy": {
        "Lower Door": ("Upper Skyloft", "Knight Academy Lower Door"),
        "Upper Door": ("Upper Skyloft", "Knight Academy Upper Door"),
    },
    "Upper Skyloft - Zelda's Room": {
        "Zelda's Door": "Upper Skyloft - Knight Academy",
    },
    ...
    "Central Skyloft": {
        ...
        "Bazaar North Entrance": ("Central Skyloft - Bazaar", "North Exit"),
        "Bazaar South Entrance": ("Central Skyloft - Bazaar", "South Exit"),
        "Bazaar West Entrance": ("Central Skyloft - Bazaar", "West Exit"),
        "Orielle and Parrow's House": "Central Skyloft - Orielle and Parrow's House",
        "Kukiel's House": "Central Skyloft - Kukiel's House",
        "Piper's House": "Central Skyloft - Piper's House",
        "Peatrice's House": "Central Skyloft - Peatrice's House",
        "Waterfall Cave": "Central Skyloft - Waterfall Cave",
    ...
    "Central Skyloft - Under Waterfall": {
        "Cave Entrance": "Central Skyloft - Waterfall Cave",
        "Loftwing Platforms": "Sky",
    },
    "Central Skyloft - Bazaar": {
        "North Exit": ("Central Skyloft", "Bazaar North Entrance"),
        "South Exit": ("Central Skyloft", "Bazaar South Entrance"),
        "West Exit": ("Central Skyloft", "Bazaar West Entrance"),
    },
    "Central Skyloft - Orielle and Parrow's House": {
        "Door": "Central Skyloft",
    },
    ...
    "Central Skyloft - Waterfall Cave": {
        "Upper Cave Exit": "Central Skyloft",
        "Lower Cave Exit": "Central Skyloft - Under Waterfall",
    },
    "Skyloft Village": {
        "Bridge to Central Skyloft": "Central Skyloft",
        "Shed Door to Batreaux's House": "Batreaux's House",
        "Sparrot's House": "Skyloft Village - Sparrot's House",
        "Bertie's House": "Skyloft Village - Bertie's House",
        "Gondo's House": "Skyloft Village - Gondo's House",
        "Pipit's House": "Skyloft Village - Pipit's House",
        "Rupin's House": "Skyloft Village - Rupin's House",
        "Loftwing Platforms": "Sky",
    },
    "Skyloft Village - Sparrot's House": {
        "Door": "Skyloft Village",
    },
    ...
    "Beedle's Shop": {
        "Shop Day Exit": "Central Skyloft",
        "Shop Night Exit": "Sky - Beedle's Island - Night"
    },
    "Sky": {
        ...
        "Land at Triple Island": "Sky - Triple Island",
        "Land at Fun Fun Island": "Sky - Fun Fun Island",
        "Land at Orielle's Island": "Sky - Orielle's Island",
        "Land at Volcanic Island": "Sky - Volcanic Island",
        "Land at Island near Faron Pillar": "Sky - Island near Faron Pillar",
        "Land at Lumpy Pumpkin": "Sky - Lumpy Pumpkin - Outside",
        "Land at Northeast Island": "Sky - Northeast Island",
        "Land at Beedle's Island": "Sky - Beedle's Island - Day",
        "Land at Island next to Bamboo Island": "Sky - Island next to Bamboo Island",
        "Land at Bamboo Island": "Sky - Bamboo Island - Outside",
    },
    "Sky - Triple Island": {
        "Fly to Sky": "Sky",
    },
    ...
    "Sky - Lumpy Pumpkin - Outside": {
        "Fly to Sky": "Sky",
        "South Door": ("Sky - Lumpy Pumpkin - Inside", "Front Door"),
        "North Door": ("Sky - Lumpy Pumpkin - Inside", "Back Door"),
    },
    "Sky - Lumpy Pumpkin - Inside": {
        "Front Door": ("Sky - Lumpy Pumpkin - Outside", "South Door"),
        "Back Door": ("Sky - Lumpy Pumpkin - Outside", "North Door"),
    },
    ...
    "Sky - Bamboo Island - Outside": {
        "Fly to Sky": "Sky",
        "Door": "Sky - Bamboo Island - Inside",
    },
    "Sky - Bamboo Island - Inside": {
        "Door": "Sky - Bamboo Island - Outside",
    },
    "Thunderhead": {
        "Opening in Clouds": "Sky",
        "Land at East Island": "Thunderhead - East Island",
        "Land at Isle of Songs": "Thunderhead - Isle of Songs - Outside",
        "Land at Mogma Mitts Island": "Thunderhead - Mogma Mitts Island",
        "Land at Bug Heaven": "Thunderhead - Bug Heaven",
        "Land at Island next to Bug Heaven": "Thunderhead - Island next to Bug Heaven",
    },
    "Thunderhead - East Island": {
        "Fly to Thunderhead": "Thunderhead",
    },
    "Thunderhead - Isle of Songs - Outside": {
        "Fly to Thunderhead": "Thunderhead",
        "Crawlspace after Bridge Puzzle": "Thunderhead - Isle of Songs - Inside",
    },
    "Thunderhead - Isle of Songs - Inside": {
        "Crawlspace": "Thunderhead - Isle of Songs - Outside",
    },
    ...
    "Sealed Grounds - Spiral": {
        ...
        "Path behind Log": "Sealed Grounds - Behind the Temple",
    },
    ...
    "Sealed Grounds - Behind the Temple": {
        "Fly to Sky": "Sky",
        "Sealed Temple": "Sealed Grounds - Sealed Temple",
        "Path after Vines": "Sealed Grounds - Spiral",
    ...
    "Faron Woods - In the Woods": {
        ...
        "Shortcut to Floria Waterfall": "Lake Floria - Waterfall"
    },
    ...
    "Faron Woods - Inside Upper Great Tree": {
        ...
        "Speak to Water Dragon": "Flooded Faron Woods - Great Tree",
    },
    ...
    "Flooded Faron Woods": {
        "Great Tree": "Flooded Faron Woods - Great Tree",
    },
    "Flooded Faron Woods - Great Tree": {
        "Speak to Water Dragon": "Faron Woods - Inside Upper Great Tree",
        "Exit Great Tree": "Flooded Faron Woods",
    },
    ...
    "Eldin Volcano - Near Temple Entrance": {
        ...
        "Upper Eldin Cave": "Eldin Volcano - Fire Dragon Dummy Room 2",
    ...
    "Eldin Volcano - Bottom of Sand Slide": {
        "Volcano Ascent": "Eldin Volcano - Volcano Ascent",
        "Hot Cave": "Eldin Volcano - Hot Cave",
        "Lower Eldin Cave": "Eldin Volcano - Fire Dragon Dummy Room 1"
    },
    "Eldin Volcano - Fire Dragon Dummy Room 1": {
        "Cave Exit": "Eldin Volcano - Bottom of Sand Slide",
    },
    "Eldin Volcano - Fire Dragon Dummy Room 2": {
        "Cave Exit": "Eldin Volcano - Near Temple Entrance",
    },
    "Mogma Turf - Entry": {
    ...
    "Bokoblin Base - Volcano": {
        ...
        "Lower Bokoblin Base Cave": "Bokoblin Base - Fire Dragon Dummy Room 1",
    },
    "Bokoblin Base - Top of Volcano": {
        "Path through Hot Cave": "Bokoblin Base - Summit",
        "Upper Bokoblin Base Cave": "Bokoblin Base - Fire Dragon Dummy Room 2",
    },
    "Bokoblin Base - Fire Dragon Dummy Room 1": {
        "Cave Exit": "Bokoblin Base - Volcano",
    },
    "Bokoblin Base - Fire Dragon Dummy Room 2": {
        "Cave Exit": "Bokoblin Base - Top of Volcano",
    },
    ...
    "Lanayru Sand Sea - Sea": {
        ...
        "Dock at Shipyard": "Lanayru Sand Sea - Shipyard - Outside",
        "Dock at Pirate Stronghold": "Lanayru Sand Sea - Pirate Stronghold - Outside",
    ...
    "Lanayru Sand Sea - Skipper's Retreat - Top of Skipper's Retreat": {
        "Outside Shack": "Lanayru Sand Sea - Skipper's Retreat - Outside Shack",
    },
    "Lanayru Sand Sea - Skipper's Retreat - Outside Shack": {
        "Shack Door": "Lanayru Sand Sea - Skipper's Retreat - Inside Shack",
        "Top of Skipper's Retreat": "Lanayru Sand Sea - Skipper's Retreat - Top of Skipper's Retreat",
        "After Rock": "Lanayru Sand Sea - Skipper's Retreat - After Rock",
        "Skydive": "Lanayru Sand Sea - Skipper's Retreat - Skydive",
    },
    "Lanayru Sand Sea - Skipper's Retreat - Inside Shack": {
        "Door": "Lanayru Sand Sea - Skipper's Retreat - Outside Shack"
    },
    ...
    "Lanayru Sand Sea - Shipyard - Outside": {
        "Fly to Sky": "Sky",
        "Boat to Sea": "Lanayru Sand Sea - Sea",
        "Roller Coaster": "Lanayru Sand Sea - Shipyard - Past Roller Coaster",
    ...
    "Lanayru Sand Sea - Shipyard - Construction Bay": {
        "Upper Door": "Lanayru Sand Sea - Shipyard - Past Roller Coaster",
        "Lower Door": "Lanayru Sand Sea - Shipyard - Outside",
    },
    "Lanayru Sand Sea - Pirate Stronghold - Outside": {
        "Fly to Sky": "Sky",
        "Boat to Sea": "Lanayru Sand Sea - Sea",
        "Side Door": "Lanayru Sand Sea - Pirate Stronghold - Inside",
        "Open Jaw": "Lanayru Sand Sea - Pirate Stronghold - Under Jaw",
    },
    "Lanayru Sand Sea - Pirate Stronghold - Under Jaw": {
        "Open Jaw": "Lanayru Sand Sea - Pirate Stronghold - Outside",
        "Door under Jaw": "Lanayru Sand Sea - Pirate Stronghold - Inside",
    },
    "Lanayru Sand Sea - Pirate Stronghold - Inside": {
        "Upper Door": "Lanayru Sand Sea - Pirate Stronghold - Outside",
        "Lower Door": "Lanayru Sand Sea - Pirate Stronghold - Under Jaw",
    },
